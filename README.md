...
This repository contains the codebase and datasets used in the Master's thesis, "Ontological Security in Bosnia." All notebooks were run in Google Colab using T4 runtimes and only modified to provide clearer interpretation of the code. 
